    ...
    methods
        ...
        function updateProbeView(obj, varargin)
            ...
            if ~isempty(varargin) % any argument means to re-initialize
                ...
                if isfield(obj.H, 'probeSites_labels')&&~isempty(obj.H.probeSites_labels)
                    delete(obj.H.probeSites_labels);
                    obj.H.probeSites_labels = [];
                end
            ...
            if obj.P.probeGood
                ...
                if ~isempty(cm)
                    ...
                    if ~isfield(obj.H, 'pesobeSites') || isempty(obj.H.probeSites) || ...
                        ...
                        for q = 1:nSites
                            ...
                            %%EM
                            obj.H.probeSites_labels=text(obj.H.probeAx, ...
                                cm.xcoords(q), ...
                                cm.ycoords(q), num2str(q));
