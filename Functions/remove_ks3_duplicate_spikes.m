...
function rez = remove_ks3_duplicate_spikes(rez, varargin)
    ...
    addParameter(input_parser, 'channel_separation_um', 40, @(x) (ischar(x))) % the spatial window within which pairs of spikes will be considered duplicates (if they are also within the temporal window)
